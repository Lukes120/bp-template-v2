...
function renderForm(){
  ...
  return renderTopnav() +
    ...
    '</div></div></div>' +
    '<div class="card sec-card-mano"><div class="sec-title sec-mano"><i class="fas fa-hard-hat"></i>Manodopera</div><div class="card-body"><table><thead><tr><th>Categoria</th><th>h/uomo</th><th>Costo/h</th><th>Costo Tot.</th><th>Markup %</th><th>Prezzo Vendita</th><th>Margine</th><th></th></tr></thead><tbody>' + manRows + '</tbody><tfoot><tr><td colspan="3" style="text-align:left">TOTALE</td><td>' + fmt(c.tCP) + '</td><td></td><td style="color:var(--o-action)">' + fmt(c.tVP) + '</td><td class="td-mg">' + fmt(c.tVP - c.tCP) + '</td><td></td></tr></tfoot></table><button class="add-row" onclick="addRow(\'personale\')"><i class="fas fa-plus-circle"></i>Aggiungi riga</button></div></div>' +
    '<div class="card sec-card-mat"><div class="sec-title sec-mat"><i class="fas fa-boxes"></i>Materiali</div><div class="card-body"><table><thead><tr><th>Descrizione</th><th>Qta</th><th>Costo Unit.</th><th>Costo Tot.</th><th>Markup %</th><th>Prezzo Vendita</th><th>Margine</th><th></th></tr></thead><tbody>' + matRows + '</tbody><tfoot><tr><td colspan="3" style="text-align:left">TOTALE</td><td>' + fmt(c.tCM) + '</td><td></td><td style="color:var(--o-action)">' + fmt(c.tVM) + '</td><td class="td-mg">' + fmt(c.tVM - c.tCM) + '</td><td></td></tr></tfoot></table><button class="add-row" onclick="addRow(\'materiali\')"><i class="fas fa-plus-circle"></i>Aggiungi riga</button></div></div>' +
    '<div class="card sec-card-serv"><div class="sec-title sec-serv"><i class="fas fa-handshake"></i>Servizi e Subappalti</div><div class="card-body"><table><thead><tr><th>Descrizione</th><th>Qta</th><th>Costo Unit.</th><th>Costo Tot.</th><th>Markup %</th><th>Prezzo Vendita</th><th>Margine</th><th></th></tr></thead><tbody>' + serRows + '</tbody><tfoot><tr><td colspan="3" style="text-align:left">TOTALE</td><td>' + fmt(c.tCS) + '</td><td></td><td style="color:var(--o-action)">' + fmt(c.tVS) + '</td><td class="td-mg">' + fmt(c.tVS - c.tCS) + '</td><td></td></tr></tfoot></table><button class="add-row" onclick="addRow(\'servizi\')"><i class="fas fa-plus-circle"></i>Aggiungi riga</button></div></div>' +
    '<div class="card sec-card-manut"><div class="sec-title sec-manut"><i class="fas fa-wrench"></i>Manutenzione</div><div class="card-body"><table><thead><tr><th>Descrizione</th><th>Qta</th><th>Costo/Un</th><th>Costo Tot.</th><th>Markup %</th><th>Prezzo Vendita</th><th>Margine</th><th></th></tr></thead><tbody>' + manRows2 + '</tbody><tfoot><tr><td colspan="3" style="text-align:left">TOTALE</td><td>' + fmt(c.tCM2) + '</td><td></td><td style="color:var(--o-action)">' + fmt(c.tVM2) + '</td><td class="td-mg">' + fmt(c.tVM2 - c.tCM2) + '</td><td></td></tr></tfoot></table><button class="add-row" onclick="addRow(\'manutenzione\')"><i class="fas fa-plus-circle"></i>Aggiungi riga</button></div></div>' +
    '<div class="card sec-card-tras"><div class="sec-title sec-tras"><i class="fas fa-car"></i>Trasferte</div><div class="card-body"><table><thead><tr><th>Descrizione</th><th>Persone</th><th>Giorni</th><th>Costo/g/pers</th><th>Vitto/p/g</th><th>Alloggio/p/g</th><th>Km</th><th>EUR/km</th><th>Costo Tot.</th><th>Markup %</th><th>Prezzo Vendita</th><th>Margine</th><th></th></tr></thead><tbody>' + traRows + '</tbody><tfoot><tr><td colspan="8" style="text-align:left">TOTALE</td><td>' + fmt(c.tCT) + '</td><td></td><td style="color:var(--o-action)">' + fmt(c.tVT) + '</td><td class="td-mg">' + fmt(c.tVT - c.tCT) + '</td><td></td></tr></tfoot></table><button class="add-row" onclick="addRow(\'trasferte\')"><i class="fas fa-plus-circle"></i>Aggiungi riga</button></div></div>' +
